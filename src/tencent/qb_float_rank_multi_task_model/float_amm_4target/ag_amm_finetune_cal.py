...
class Runner(NumerousModel):
    ...
    def compute_loss(self, labels, model_outputs, training):
        ...
        amm_loss = tf.multiply(is_positive_sample, amm_loss) * amm_weight

        pointwise_loss = skip_loss_ce + finish_loss_ce + ratio_loss_ce + time_loss_ce
        denoise_loss = (denoise_loss_finish + denoise_loss_skip) * denoise_weight
        final_loss = pointwise_loss + denoise_loss + amm_loss
