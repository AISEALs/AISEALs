...
def parser(example_proto,class_num=None):
    ...
    feature_to_type = {
        "t_c": tf.FixedLenFeature([512], tf.int64),
    ...
    return parsed_features['t_c'], labels_onehot
...
def train():
    ...
    with tf.Graph().as_default(),tf.device('/GPU:0'):
        ...
        with sess.as_default():
            ...
            title_content_batch, label_batch = iterator.get_next()
            ...
            title_content_batch_test, label_batch_test = iterator_test.get_next()
            ...
            cnn = TextCNN(
                ...
                features=title_content_batch, labels=label_batch,
                features_test=title_content_batch_test, labels_test=label_batch_test
            )
